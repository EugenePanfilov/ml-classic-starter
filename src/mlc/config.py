...
class FeaturesConfig:
    ...
    cat_imputer: Dict[str, Any] = field(default_factory=lambda: {"strategy": "most_frequent"})
    scaler: Dict[str, Any] = field(default_factory=dict)
    encoder: Dict[str, Any] = field(default_factory=lambda: {"handle_unknown": "ignore"})

@dataclass
class ModelConfig:
    GradientBoostingClassifier: Dict[str, Any] = field(default_factory=lambda: {"random_state": 42})
